...
Response = (function () {
  ...
  Response.prototype._respond = function (data, status, method = 'succeed') {
    logger.info(this._platform.getLoggingSignature(), 'Response._respond', ...arguments)
    ...
    logger.info(this._platform.getLoggingSignature(), 'Response._respond', '_context', method, out)
